...
<html>
	...
	foreach($retourCommandes as $commande) { ?>
		...
		<h1>Hockey Embourg - Saint Nicolas 2025</h1>
		...
		<table class="Commande">
			...
			<tbody>
				<tr>
					<td>Repas Adulte</td>
					<td width="20%"><?php echo(intval($commande[6])); ?> x 20 €<td>
					<td width="15%"><?php echo(intval($commande[6]) * $tarifAdulte); ?> €</td>
				</tr>
				
				<tr>
					<td>Repas Enfants</td>
					<td><?php echo(intval($commande[7])); ?> x 15 €<td>
					<td><?php echo(intval($commande[7]) * $tarifEnfant); ?> €</td>
				</tr>
				<tr>
					<td><b>Total</b></td>
					<td></td>
					<td></td>
					<td><b><?php echo(intval($commande[6]) * $tarifAdulte + intval($commande[7]) * $tarifEnfant); ?> €</b></td>
				</tr>	
			</tbody>
		</table>	
		...
		<table class="Tickets">
			<tbody>
				<!-- Ligne Enfants -->
				<?php for($x = 0; $x < intval($commande[7]); $x++) {  ?>
				<tr>
					<td width="30%">
			...
			<?php } ?>
				...
				<!-- Ligne Adulte -->
			<?php for($x = 0; $x < intval($commande[6]); $x++) {  ?>
			<tr>
				<td width="30%">
				...
				<td width="30%">
					...
					<span class="Food">&#x1F32E&#x1F336</span>
				</td>
				<td width="30%">
					<!-- Ticket Vierge -->
				</td>
